...
function BarChartComponent({attendaceList,totalPresentData}) {
  ...
  return (
    <div className='p-5 border rounded-lg shadow-sm'>
        <h2 className='my-2 font-bold text-lg'>การเข้าเรียน/Attendance</h2>
    ...
    <BarChart  data={data}>
        ...
        <Tooltip />
        <Legend />
        <Bar dataKey="presentCount" name="จำนวนการขาดเรียน/Total Present" fill="#4c8cf8" />
        <Bar dataKey="absentCount" name="จำนวนการเข้าเรียน/Total Absent" fill="#1fe6d1" />
</BarChart>
</ResponsiveContainer>
    </div>
  )
