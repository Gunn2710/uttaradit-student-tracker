...
function StatusList({attendaceList}) {
  ...
  return (
    ...
    md:grid-cols-2 lg:grid-cols-3 gap-5 my-6'>
        <Card icon={<GraduationCap/>} title='นักเรียนทั้งหมด/Total Student' value={totalStudent} />
        <Card icon={<TrendingUp/>} title='จำนวนการเข้าเรียน/Total Present' value={presentPerc.toFixed(1)+'%'} />
        <Card icon={<TrendingDown/>} title='จำนวนการขาดเรียน/Total Absent' value={(100-presentPerc).toFixed(1)+"%"} />
